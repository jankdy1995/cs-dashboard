...
(function(){
  ...
  if(missing){
    ...
    note.textContent='Hinweis: Eine „On track"-Spalte liegt aktuell nur für Eli im Team-Sheet vor. Sobald sie auch für die übrigen Agents gepflegt ist, erscheint deren Status automatisch — sag mir Bescheid, wenn die Spalten ergänzt sind, dann verknüpfe ich sie.';
    card.append(note);
  }
  sec.append(card);
})();
...
document.querySelectorAll('.section-title').forEach(title=>{
  ...
  if(!content||!content.matches('.tiles,.grid'))return;
