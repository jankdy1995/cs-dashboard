...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* Kachel-Akzente (dezent getönt) */
  .tiles .tile:nth-child(8n+1){border-top:3px solid var(--s1);background:color-mix(in srgb,var(--s1) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+2){border-top:3px solid var(--s2);background:color-mix(in srgb,var(--s2) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+3){border-top:3px solid var(--s3);background:color-mix(in srgb,var(--s3) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+4){border-top:3px solid var(--s5);background:color-mix(in srgb,var(--s5) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+5){border-top:3px solid var(--s6);background:color-mix(in srgb,var(--s6) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+6){border-top:3px solid var(--s7);background:color-mix(in srgb,var(--s7) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+7){border-top:3px solid var(--s8);background:color-mix(in srgb,var(--s8) 5%,var(--surface-1));}
  .tiles .tile:nth-child(8n+8){border-top:3px solid var(--s4);background:color-mix(in srgb,var(--s4) 5%,var(--surface-1));}
